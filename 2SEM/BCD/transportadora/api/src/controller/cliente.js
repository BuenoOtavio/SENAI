...
const updateCliente = (req, res) => {
    if (req.body != null && req.body.idCliente != null && req.body.nome != null && req.body.endereco != null && req.body.telefone != null && req.body.email != null) {
        const { idCliente, nome, endereco, telefone, email } = req.body;
        con.query('UPDATE cliente SET nome = ?, endereco = ?, telefone = ?, email = ? WHERE idCliente = ?', [nome, endereco, telefone, email, idCliente], (err, result) => {
            if (err) {
