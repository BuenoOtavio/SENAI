...
const addPedido = (req, res) => {
    if (req.body != null && req.body.idCliente != null && req.body.idEntrega != null && req.body.dataPedido != null && req.body.valor != null) {
...
const updatePedido = (req, res) => {
    if (req.body != null != null && req.body.idCliente != null && req.body.idEntrega != null && req.body.dataPedido != null && req.body.valor != null) {
        const { idPedido, idCliente, idEntrega, dataPedido, valor} = req.body;
        con.query('UPDATE pedido SET idCliente = ?, idEntrega = ?, dataPedido = ?, valor = ? WHERE idPedido = ?', [idCliente, idEntrega, dataPedido, valor , idPedido], (err, result) => {
            if (err) {
